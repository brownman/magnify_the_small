_timer()
{
    ...
    COMMANDS="$COMMANDS $('ls' ${timer_ACTIONS_DIR:-$HOME/.timer.actions.d}/ 2>/dev/null)"
...
complete -F _timer timer.sh
# If you define an alias (e.g. "t") to timer.sh, you need to explicitly enable
